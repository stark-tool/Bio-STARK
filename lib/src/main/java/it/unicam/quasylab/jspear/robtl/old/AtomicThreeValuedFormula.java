...
public final class AtomicThreeValuedFormula implements ThreeValuedFormula {
    ...
    public AtomicThreeValuedFormula(Perturbation perturbation, DistanceExpression expr, RelationOperator relop, double value, int m, double z) {
