...
public final class MinIntervalDistanceExpression implements DistanceExpression {
    ...
    public double computeLeq(int step, EvolutionSequence seq1, EvolutionSequence seq2) {
        ...
        return IntStream.range(from+step, to+step)
                .sequential()
                .mapToDouble(i -> argument.computeLeq(i, seq1, seq2))
                .min()
                .orElse(Double.NaN);
    }
    ...
    public double computeGeq(int step, EvolutionSequence seq1, EvolutionSequence seq2) {
        ...
        return IntStream.range(from+step, to+step)
                .sequential()
                .mapToDouble(i -> argument.computeGeq(i, seq1, seq2))
                .min()
                .orElse(Double.NaN);
    }
    ...
    public double[] evalCILeq(int step, EvolutionSequence seq1, EvolutionSequence seq2, int m, double z) {
         ...
         */
        res[0] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCILeq(i, seq1, seq2, m, z)[0]).min().orElse(Double.NaN);
        res[1] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCILeq(i, seq1, seq2, m, z)[1]).min().orElse(Double.NaN);
        res[2] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCILeq(i, seq1, seq2, m, z)[2]).min().orElse(Double.NaN);
        return res;
    }
    ...
    public double[] evalCIGeq(int step, EvolutionSequence seq1, EvolutionSequence seq2, int m, double z) {
         ...
         */
        res[0] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCIGeq(i, seq1, seq2, m, z)[0]).min().orElse(Double.NaN);
        res[1] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCIGeq(i, seq1, seq2, m, z)[1]).min().orElse(Double.NaN);
        res[2] = IntStream.range(from+step, to+step).parallel().mapToDouble(i -> argument.evalCIGeq(i, seq1, seq2, m, z)[2]).min().orElse(Double.NaN);
        return res;
    }
