...
fix, ax = plt.subplots()
ax.plot(range(0,100),WRN_max['wrn_max'],label="warning")
ax.plot(range(0,100),STRESS_max['stress_max'],label="stress")
legend = ax.legend()
