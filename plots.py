...
fix, ax = plt.subplots()
ax.plot(range(90,300),TEMP_off1['temp_off1'],label="offset = -1")
ax.plot(range(90,300),TEMP_off['temp_off'],label="offset = -1.5")
ax.plot(range(90,300),TEMP_off2['temp_off2'],label="offset = -2")
legend = ax.legend()
plt.title("Variation of temperature wrt different offsets")
...
fix, ax = plt.subplots()
ax.plot(range(90,220),STRESS_off1['stress_off1'],label="offset = -1")
ax.plot(range(90,220),STRESS_off['stress_off'],label="offset = -1.5")
ax.plot(range(90,220),STRESS_off2['stress_off2'],label="offset = -2")
legend = ax.legend()
plt.title("Variation of stress wrt different offsets")
